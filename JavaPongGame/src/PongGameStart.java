public class PongGameStart {
	...
	public static void main(String[] args) {
		 ...
		 * - TODO: Change background color using JColorChooser class
		 ...
		 * - TODO: Add match point sound effect or when players are 1 point away
		 * - TODO: Add Option to change player one and two names in Settings
		 * - TODO: Clean Java Audio code, make File objects before classes
		 */
